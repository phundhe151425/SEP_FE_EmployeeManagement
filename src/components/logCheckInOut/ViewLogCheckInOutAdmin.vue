<template>
    <div style="padding-bottom: 36px;">
        <div className="container" style="text-align: center; width: 100%;margin: auto">
            <h3 class="text-start" style="font-weight: bold">Log Check-in/Check-out</h3>
            <hr />
            <br>
            <el-row :gutter="20">
                <el-col :md="6" :lg="6" :xl="5" style="margin-bottom: 20px;">
                    <div class="grid-content">
                        ...
                        <el-select
                            ...
                            @change="getLogCheckInOut"
                            placeholder="Chon Phòng ban"
                        >
                            <el-option value="" label="Tất cả phòng ban"></el-option>
                            <el-option
                ...
                <el-col :md="6" :lg="6" :xl="5" style="">
                    <div class="grid-content">
                        ...
                        <el-input v-model="search" @input="getLogCheckInOut" size="medium"
...
import LogCheckInOutService from "@/services/log-checkInOut-service";
...
export default {
    ...
    methods: {
        ...
        getLogCheckInOut() {
            ...
            LogCheckInOutService.getData(params).then(response => {
