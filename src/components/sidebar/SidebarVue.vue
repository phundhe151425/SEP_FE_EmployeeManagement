    ...
    <div class="user-detail nav-item dropdown">
      ...
      >
        ...
        <b-avatar
          ...
          class="mr-3"
          v-bind:src="this.beUrl + `api/file/avatar/` + currentUser.userImage"
        ></b-avatar>
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
            ...
            <li class="nav-item mb-1" v-if="currentUser">
              <button
                class="nav-link sel btn-drop"
                aria-current="page"
                data-bs-toggle="collapse"
                data-bs-target="#getting-started-collapse1"
                aria-expanded="false"
              >
                <i class="el-icon-star-on" /> Cá nhân
            ...
            <li class="nav-item mb-1" v-if="isAdmin || isModerator">
              <button
                ...
                aria-expanded="false"
              >
                <i class="el-icon-s-fold" /> Thông tin chấm công<i
            ...
            <li class="nav-item mb-1" v-if="isAdmin || isModerator">
              <button
                ...
                aria-current="page"
                data-bs-toggle="collapse"
                data-bs-target="#getting-started-collapse3"
                aria-expanded="false"
              >
                <i class="el-icon-s-tools" /> Quản Lý
                <i class="el-icon-arrow-right" />
              </button>
